...
<section class="tj-subscribe-section">
                        ...
                        <div class="form-box-one">
                            ...
                            <div class="subscribe-button">
                                <button class="tj-primary-btn btn" type="submit" value="submit">
                                    Envoyer un message maintenant <i class="flaticon-right-arrow"></i>
                                </button>
                            </div>
                        </div>
                    </div>
    ...
    <div class="subscribe-bg-shape">
        <div class="shape-1">
            <img src="{{ asset('assets/images/shape/solar.svg') }}" alt="Shape" />
        </div>
        <div class="shape-two">
                    ...
                    <div class="footer-widget footer1-col-1">
                        <div class="footer-info">
                            <div class="footer-logo">
                                <a href="index.html"><img src="{{ asset('assets/images/im2.png') }}"
                                        alt="Logo" /></a>
                            </div>
                            <div class="desc">
                                <p>
