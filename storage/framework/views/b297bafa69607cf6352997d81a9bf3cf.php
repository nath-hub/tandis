...
<section class="tj-subscribe-section">
    ...
    <div class="subscribe-bg-shape">
        <div class="shape-1">
            <img src="<?php echo e(asset('assets/images/shape/solar.svg')); ?>" alt="Shape" />
        </div>
        <div class="shape-two">
...
<footer class="tj-footer-area">
                    ...
                    <div class="footer-widget footer1-col-1">
                        <div class="footer-info">
                            <div class="footer-logo">
                                <a href="index.html"><img src="<?php echo e(asset('assets/images/im2.png')); ?>"
                                        alt="Logo" /></a>
                            </div>
                            <div class="desc">
                                <p>
                        ...
                        <div class="footer-newsletter">
                            <div class="desc">
                                <p>
                                    ...
                                    Investir dans des petites et moyennes entreprises africaines solides et prometteuses
                                    est la solution que TANDIS INVEST a la grosse ambition de mettre dans les mains de
                                    la diaspora africaine, des épargnants européens et des personnes locales.
                                </p>
                            </div>
                ...
                <div class="col-lg-12">
                    <div class="copyright-content-ara">
                        <div class="copyright-text">
                            <p>
                                Copyright © 2024 <a href="#" target="_blank"> Nath-hub. </a> All Rights
                                Reserved.
                            </p>
                        </div>
    ...
    <div class="footer-section-shape">
        <div class="secton-group-one">
            <div class="shape-one">
                <img src="<?php echo e(asset('assets/images/shape/footer-1.svg')); ?>" alt="Shape" />
            </div>
            <div class="shape-two">
                <img src="<?php echo e(asset('assets/images/shape/footer-2.svg')); ?>" alt="Shape" />
            </div>
            <div class="shape-three">
                <img src="<?php echo e(asset('assets/images/shape/footer-3.svg')); ?>" alt="Shape" />
            </div>
            <div class="shape-four">
                <img src="<?php echo e(asset('assets/images/shape/footer-4.svg')); ?>" alt="Shape" />
            </div>
            <div class="shape-five">
                <img src="<?php echo e(asset('assets/images/shape/footer-8.svg')); ?>" alt="Shape" />
            </div>
        </div>
        <div class="secton-group-two">
            <div class="shape-one">
                <img class="image-1" src="<?php echo e(asset('assets/images/shape/footer-5.svg')); ?>" alt="Shape" />
                <img class="image-2" src="<?php echo e(asset('assets/images/shape/footer-6.svg')); ?>" alt="Shape" />
            </div>
            <div class="shape-two">
                <img class="image-1" src="<?php echo e(asset('assets/images/shape/footer-5.svg')); ?>" alt="Shape" />
                <img class="image-2" src="<?php echo e(asset('assets/images/shape/footer-6.svg')); ?>" alt="Shape" />
...
<?php /**PATH /home/ubix-group/sites/TandisApp/resources/views/element/footer.blade.php ENDPATH**/ ?>